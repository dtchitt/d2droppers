...
$page = [];
$page['title'] = "Unique Diablo 2 Item Sales";
$page['desc'] = "Looking for great deals on unique diablo 2 items? Come check out our great prices!";

require "theme/header.php";

?>
	
	<h1 class="colorWhite">Diablo 2 Unique Items</h3>
	
	<div class="row">
<?php
$sql = "SELECT * FROM d2_full_items WHERE fi_count > 0 AND fi_type = 'Unique'"; //East
if($_SESSION['realm'] == "west")
	$sql = "SELECT * FROM d2_full_items WHERE fi_count_west > 0 AND fi_type = 'Unique'"; //West
