			...
			<nav class="navbar navbar-inverse">
				...
				<div class="collapse navbar-collapse js-navbar-collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Realm: East Ladder Softcore<span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="#">Realm: East Softcore Ladder Expansion</a></li>
							</ul>
						</li>
				...
				<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 centerAll">
							<a href="/admin/add-d2-items.php">Add New Item</a>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 centerAll">
							<a href="/admin/add-items.php">Add New Item</a>
						</div>
					</div>
				</div>
				
				<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 colorWhite">